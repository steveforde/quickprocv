...
document.getElementById("buy-pro-btn")?.addEventListener("click", () => {
  ...
  // Download PDF Button Listener (simplified to use browser print)
...
if (downloadPdfBtn) {
  downloadPdfBtn.addEventListener('click', () => {
    ...
    setTimeout(() => {
      ...
      // Remove print-mode class after a delay (after print dialog closes)
      setTimeout(() => {
        if (preview) preview.classList.remove('print-mode-tech');
      }, 1000);
    }, 50);
  });
} else {
